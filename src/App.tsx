...
// 【 頁籤四：贊助廠商 】
// -------------------------------------------------------------
const NORMAL_SPONSORS = [
  "劉智華學長", "寶山精緻美食",
  "宏恩眼鏡", "祥贏投注站", "善心人士", "善心人士", "卦山不動產",
  "四光南記", "麵屋三金",
  "馬駿工業(股)公司", "龍哥雞排", "好像是手機維修行", "長江素食店", "富田中藥行", "蓉來",
  "康寶十全藥燉排骨", "寶來大腸麵線", "A古爌肉飯", "隨緣珍珠奶", "阿誠現炒", "阿智鵝肉大王", "百華味",
  "鳳山米糕", "品翔當歸鴨大埔店", "有種鹽水雞", "來吉烤鴨", "九色香雞排", "微甜日光", "修護師手機平板專業維修",
  "福田家咖哩食堂", "牛太郎", "米香園", "善心人士", "發發發發允得商行", "彩碗", "熱浪小島", "徐師父麻辣臭豆腐",
  "守飛雞蛋糕", "麥田早餐店", "明記燒鴨", "安可專業眼鏡", "洪鹽酥雞", "十九甲雞排", "旅人阿宏", "三民烤肉",
  "里仁", "翔泰專業眼鏡公司", "大業機車行", "尚品芋園", "肉圓仔", "鑫鮮味臭臭鍋", "蜀都大埔店", "向日葵",
  "我家雞排大埔店", "吳家紅茶冰大埔店", "財𨪛車行", "揪吃芭樂", "阿忠刈包", "水果攤", "七七七彩券行",
  "林二代瓜仔魯炒麵", "美庚深海深美食坊", "福田眼鏡行", "聯的食品", "義式88杯麵", "女3C手機配件",
  "桂香坊冰糖醬滷味", "善心人士樂捐", "斑馬喫茶館", "大肚量＆小肚量茶飲站", "聯成書局", "DOZO", "大媽の店",
  "阿鍋·家(南郭店)", "善心人士", "心喜手工茶", "珍北平豬肉餡餅", "米豐", "佬台南鍋燒意麵", "南北第七家",
  "手機工廠", "蟹將軍", "鑫億來投注站", "永晟機車行", "楊小姐", "華新運動", "客多法式捲餅", "牛媽媽",
  "田原茶鋪", "九品現炒", "發財臭豆腐", "府城", "如意早餐", "滿香中西式早餐", "ANGEL髮藝空間", "善心人士",
  "善心人士", "雅頓彰化陽明店", "泰宇電腦", "橙品快炒店", "全香肉乾", "御麵棧美食", "瑞興中藥行",
  "澎湖伯豆花圓仔", "楓木芸藝術花坊", "善心人士", "三民木瓜牛乳", "回生中藥行", "彩虹照相館", "善心人士",
  "早安家", "食神滷味", "瘋雞鹽酥雞", "榆蓉會館", "善心人士", "善心人士", "吳記茶舍", "朋志書局",
      ...
      <div className="p-6 md:px-10 flex flex-col gap-10">
        ...
        <div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-3">
            {NORMAL_SPONSORS.map((sponsorName, i) => (
              <motion.div 
                key={i}
              ...
              >
                <div className="font-medium text-slate-200 text-sm lg:text-base">{sponsorName}</div>
              </motion.div>
            ))}
          </div>
        </div>
